...
`
            ...
            rendered = rendered.replace(/\{\{#(\w+)\}\}(.*?)\{\{\/\1\}\}/gs, (match, arrayName, blockContent) => {
                ...
                return array.map(item => {
                    ...
                    if (typeof item === 'object' && item !== null) {
                        itemContent = itemContent.replace(/\{\{(\w+)\}\}/g, (varMatch: string, variable: string) => {
     ...
     */
    static validateTemplateData(templateName: string, data: Record<string, any>): { valid: boolean; errors: string[] } {
