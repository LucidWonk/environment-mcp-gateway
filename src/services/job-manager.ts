...
class JobManager {
     ...
     */
    async startJob(request: JobRequest): Promise<{ jobId: string; started: boolean }> {
     ...
     */
    getRecentJobs(limit: number = 10): JobStatus[] {
     ...
     */
    private async executeFullRepositoryReindex(jobId: string, params: any): Promise<any> {
     ...
     */
    private async executeHolisticUpdate(jobId: string, params: any): Promise<any> {
     ...
     */
    private async executeCrossDomainAnalysis(jobId: string, _params: any): Promise<any> {
