...
export class PathUtilities {
    private static readonly COMMON_PATH_MAPPINGS: Record<string, string[]> = {
     ...
     */
    static async resolvePath(inputPath: string, options: PathValidationOptions = {}): Promise<PathResolutionResult> {
        const {
            requireExists = false,
     ...
     */
    private static async findAlternativePaths(inputPath: string): Promise<string[]> {
     ...
     */
    private static async generateEnvironmentAlternatives(inputPath: string): Promise<string[]> {
        const alternatives: string[] = [];
     ...
     */
    private static async findCaseVariations(inputPath: string): Promise<string[]> {
        ...
        const titleCase = parts.map(part => 
     ...
     */
    static async resolveDomainContextPath(domain: string, projectRoot?: string): Promise<string> {
     ...
     */
    static async getDiagnostics(inputPath: string): Promise<Record<string, any>> {
