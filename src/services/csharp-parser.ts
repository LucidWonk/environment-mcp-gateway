...
export class CSharpParser {
     ...
     */
    private extractClasses(content: string): CSharpClass[] {
     ...
     */
    private extractInterfaces(content: string): CSharpInterface[] {
     ...
     */
    private extractEnums(content: string): CSharpEnum[] {
     ...
     */
    private extractRecords(content: string): CSharpRecord[] {
        const records: CSharpRecord[] = [];
     ...
     */
    private extractMethods(classBody: string): CSharpMethod[] {
     ...
     */
    private extractInterfaceMethods(interfaceBody: string): CSharpMethod[] {
        const methods: CSharpMethod[] = [];
     ...
     */
    private extractInterfaceProperties(interfaceBody: string): CSharpProperty[] {
        const properties: CSharpProperty[] = [];
     ...
     */
    private parseParameters(parametersStr: string): CSharpParameter[] {
     ...
     */
    private extractAccessibility(declaration: string): string {
     ...
     */
    private extractNamespaceForPosition(content: string, position: number): string {
