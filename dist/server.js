...
class EnvironmentMCPGateway {
    ...
    async run() {
        ...
        try {
            ...
            this.transportHandler = transportFactory.createTransportHandler(transportConfig, this.baseServer, this.sessionManager, this.sessionAwareExecutor);
