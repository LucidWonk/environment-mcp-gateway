...
describe('Registry Lifecycle System', () => {
    ...
    describe('PlaceholderTracker', () => {
        ...
        describe('transitionPlaceholderLifecycle', () => {
            it('should transition through valid lifecycle stages', async () => {
                ...
                await placeholderTracker.transitionPlaceholderLifecycle(placeholderId, 'domain-discovery', 'Domain boundaries identified');
                ...
                await placeholderTracker.transitionPlaceholderLifecycle(placeholderId, 'implementation-active', 'Starting implementation');
                ...
                await placeholderTracker.transitionPlaceholderLifecycle(placeholderId, 'ready-for-conversion', 'Implementation complete');
                info = placeholderTracker.getPlaceholderInfo(placeholderId);
            ...
            it('should reject invalid transitions', async () => {
                ...
                await expect(placeholderTracker.transitionPlaceholderLifecycle(placeholderId, 'converted', 'Invalid jump')).rejects.toThrow('Invalid lifecycle transition: concept-exploration -> converted');
            });
            it('should handle non-existent placeholder', async () => {
                await expect(placeholderTracker.transitionPlaceholderLifecycle('TEMP-FAKE-ID-1234', 'domain-discovery', 'Test')).rejects.toThrow('Placeholder not found: TEMP-FAKE-ID-1234');
            });
        });
    ...
    describe('RegistryManager', () => {
        ...
        describe('proposeCapabilityConversion', () => {
            it('should create conversion proposal with approval', async () => {
                ...
                const conversion = await registryManager.proposeCapabilityConversion('TEMP-ANALYSIS-TEST-1234', 'ANALYSIS-TEST-FINAL-001');
            ...
            it('should reject conversion of unready placeholder', async () => {
                ...
                await expect(registryManager.proposeCapabilityConversion('TEMP-ANALYSIS-UNREADY-1234', 'ANALYSIS-UNREADY-001')).rejects.toThrow('not ready for conversion');
            });
            it('should reject conversion of non-existent placeholder', async () => {
                await expect(registryManager.proposeCapabilityConversion('TEMP-FAKE-PLACEHOLDER-1234', 'ANALYSIS-FAKE-001')).rejects.toThrow('Placeholder capability not found');
            });
        });
    ...
    describe('Integration Tests', () => {
        it('should complete full placeholder lifecycle', async () => {
            ...
            const conversion = await registryManager.proposeCapabilityConversion(placeholderId, 'ANALYSIS-INTEGRATION-FINAL-001', 'implementation-complete');
