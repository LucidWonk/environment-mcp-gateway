...
describe('PathUtilities', () => {
    ...
    describe('Path Resolution', () => {
        ...
        test('should throw when requireExists is true for non-existent path', async () => {
            const nonExistentPath = path.join(testDir, 'does-not-exist');
            await expect(PathUtilities.resolvePath(nonExistentPath, { requireExists: true })).rejects.toThrow('Required path does not exist');
        });
    ...
    describe('Error Handling', () => {
        ...
        test('should throw appropriate errors for validation failures', async () => {
            ...
            await expect(PathUtilities.resolvePath(filePath, {
                requireDirectory: true,
                requireExists: true
...
//# sourceMappingURL=path-utilities.test.js.map