...
export class NewConceptsMigrationOrchestrator {
    ...
    migrationHistory = [];
    constructor(lifecycleCoordinator, placeholderTracker, projectRoot) {
     ...
     */
    async initiateMigration(request) {
     ...
     */
    async cancelMigration(workflowId, reason) {
    ...
    async executeMigrationWorkflow(workflowId) {
        const workflow = this.activeMigrations.get(workflowId);
        if (!workflow) {
            return;
        }
    ...
    async assessConceptReadiness(conceptPath) {
    ...
    async validateMigrationResult(workflow) {
    ...
    inferDomainFromPath(conceptPath) {
...
//# sourceMappingURL=newconcepts-migration.js.map