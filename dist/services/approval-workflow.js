...
export class ApprovalWorkflowManager {
     ...
     */
    async submitResponse(approvalId, response) {
     ...
     */
    async withdrawRequest(approvalId, reason) {
    ...
    evaluateFinalDecision(workflow) {
     ...
     */
    async simulateApproval(approvalId, decision, approver = 'test-approver') {
