...
export class UpdateIntegrationOrchestrator {
     ...
     */
    async executeIntegratedUpdate(request) {
        ...
        try {
            ...
            result.affectedDomains = result.impactAnalysisResult.prediction.affectedDomains.map((d) => d.domain);
