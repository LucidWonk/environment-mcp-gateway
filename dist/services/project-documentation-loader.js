...
export class ProjectDocumentationLoader {
    ...
    constructor(projectRoot = '/mnt/m/projects/lucidwonks') {
     ...
     */
    async loadArchitectureGuidelines() {
     ...
     * Load Context Engineering Standards
     */
    async loadContextEngineeringStandards() {
     ...
     */
    async getExpertGuidance(expertType, subtask) {
    ...
    getBaseExpertGuidance(expertType, subtask) {
    ...
    getArchitectureSpecificGuidance(standards, _subtask) {
        if (!standards)
            return '';
    ...
    getTestingSpecificGuidance(standards, _subtask) {
        if (!standards)
            return '';
    ...
    getDevOpsSpecificGuidance(standards, _subtask) {
        if (!standards)
            return '';
    ...
    getContextEngineeringGuidance(standards, _subtask) {
        if (!standards)
            return '';
...
//# sourceMappingURL=project-documentation-loader.js.map